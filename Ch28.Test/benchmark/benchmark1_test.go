...
func TestFibonacci1(t *testing.T) {
	...
	assert.Equal(55, fibonacci1(10), "fibonacci(10) should be 55")
...
func TestFibonacci2(t *testing.T) {
	...
	assert.Equal(55, fibonacci2(10), "fibonacci(10) should be 55")
	assert.Equal(233, fibonacci2(13), "fibonacci(13) should be 233")
}
